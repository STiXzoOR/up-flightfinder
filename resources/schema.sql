...
--
-- Host: localhost:8889
-- Generation Time: Dec 27, 2019 at 05:24 PM
...
--
ALTER TABLE `BOOKING`
  ADD CONSTRAINT `BOOKING_fk0` FOREIGN KEY (`customer_id`) REFERENCES `CUSTOMER` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
