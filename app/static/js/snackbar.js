...
(function(factory) {
  ...
  $(document).ready(function() {
    $("body").append("<div id=snackbarContainer class=snackbar-container/>");
  });
  ...
  $.snackbar = function(options) {
    if (isset(options) && options === Object(options)) {
      ...
      var snackbarStatus = $snackbar.hasClass("show");

      if (isset(options.style)) {
        if (snackbarStatus) {
          $snackbar.attr("class", "snackbar show " + options.style);
        } else {
      ...
      options.htmlAllowed = isset(options.htmlAllowed)
        ? options.htmlAllowed
        : false;
      ...
      options.content = options.htmlAllowed
        ? options.content
        : $("<p>" + options.content + "</p>").text();
      ...
      if (isset(options.content)) {
        if ($snackbar.find(".snackbar-body").length) {
          $snackbar.find(".snackbar-body").html(options.content);
        } else {
          $snackbar.prepend(
            '<div class="snackbar-body">' + options.content + "</div>"
          );
        }
