                                ...
                                <div class="row justify-content-center align-items-center">
                                    <div class="flight-row col-12 col-sm-8 col-md-9 col-lg-8 col-xl-6 flight-card-padding-right">
                                        <div id="flightInfo" class="flight card rounded-3x flight-card-sm shadow-1 small">
                                            <div class="card-body">""".format(id=counter, post_url=post_url)
        ...
        flights += """                      </div>
                                    ...
                                    <div class="d-none d-sm-block col-sm-4 col-md-3 col-lg-2 flight-card-padding-left">
                                        <div id="flightPrice" class="price card rounded-3x shadow-1 text-center">
                                            <div class="price-body card-body d-flex flex-column justify-content-center align-items-center">""".format(id=counter, price=price)
        if is_roundtrip:
            flights += """                      <div class="font-weight-bold font-size-lg mb-2">€{price}</div>
                                                <button class="btn btn-primary process-form" type="submit">Select</button>""".format(id=counter, price=price)
        else:
            flights += """                       <button class="btn btn-primary btn-block process-form" type="submit">
                                                    Select (€{price})                                    
                                                </button>
                                                """.format(id=counter, price=price)
